<!-- Context: core/navigation | Priority: critical | Version: 1.1 | Updated: 2026-08-30 -->
...
| **Understand this project** | `project-intelligence/navigation.md` |
| **Validate this repository** | `project-intelligence/validation-commands.md` |
...
**project-intelligence/** - AZWP Mailer-specific context → `project-intelligence/navigation.md`
